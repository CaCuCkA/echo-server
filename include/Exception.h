...
#define WIN_ERROR (-1)
    ...
    EC_CANT_SET_FLAG_TO_SOCKET = SOCKET_ERROR,
    EC_CANT_GET_FLAG = SOCKET_ERROR,
    EC_WAIT_FOR_SOCKET = WIN_ERROR,
    EC_CANT_SET_SOCKET_OPTION = SOCKET_ERROR,
    EC_CANT_SELECT_SOCKET = SOCKET_ERROR,
    EC_CANT_DO_HANDSHAKE = WIN_ERROR,
#else
#define POSIX_ERROR (-1)
    ...
    EC_CANT_SET_FLAG = POSIX_ERROR,
    EC_CANT_SET_FLAG_TO_SOCKET = POSIX_ERROR,
    EC_CANT_GET_FLAG = POSIX_ERROR,
    EC_WAIT_FOR_SOCKET = POSIX_ERROR,
    EC_CANT_SET_SOCKET_OPTION = POSIX_ERROR,
    EC_CANT_ADD_SOCKET_TO_EPOLL = POSIX_ERROR,
    EC_CANT_DO_HANDSHAKE = POSIX_ERROR,
    EC_CANT_SEND_FRAME = POSIX_ERROR,
#endif
};
