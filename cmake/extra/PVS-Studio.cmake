...
set(PVS_STUDIO_SCRIPT "PVS-Studio.cmake")
...
function (pvs_studio_add_target)
    ...
    pvs_studio_set_directory_flags("." PVS_STUDIO_CXX_FLAGS PVS_STUDIO_C_FLAGS)
    ...
    if (NOT "${PVS_STUDIO_SUPPRESS_BASE}" STREQUAL "")
        pvs_studio_join_path(PVS_STUDIO_SUPPRESS_BASE "." "${PVS_STUDIO_SUPPRESS_BASE}")
    ...
    foreach (SOURCE ${PVS_STUDIO_SOURCES})
        pvs_studio_analyze_file("${SOURCE}" "." "${CMAKE_CURRENT_BINARY_DIR}")
    endforeach ()
